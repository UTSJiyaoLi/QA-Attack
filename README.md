...
- [**SQuAD 1.1**](https://huggingface.co/datasets/squad): Stanford Question Answering Dataset, a reading comprehension dataset consisting of questions posed by crowdworkers on a set of Wikipedia articles.
